//load all lensflares
var textureFlare0 = new THREE.TextureLoader().load( "lensflares/lensflare0.png" );
var textureFlare1 = new THREE.TextureLoader().load( "lensflares/lensflare1.png" );
var textureFlare2 = new THREE.TextureLoader().load( "lensflares/lensflare2.png" );
...
var Lensflare = function () {
	...
	var material2 = new THREE.RawShaderMaterial( {
		uniforms: {
			'map': { value: null },
			'occlusionMap': { value: THREE.occlusionMap },
...
lensflare.addElement( new LensflareElement( textureFlare0, 512, 1 ) );
lensflare.addElement( new LensflareElement( textureFlare1, 512, 1 ) );
